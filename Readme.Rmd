...
La versión final del trabajo puede visualizarse en: <https://pitojo.github.io/trabajo_BigData_equipo/>. 


<!-- Abajo podéis escribir lo que queráis, igual un resumen del trabajo, o ..., o ... pero al menos, tenéis que poner el título del trabajo y el nombre de los componentes del equipo-->

El título del trabajo es IMPORTANCIA DEL CRUDO EN EL MUNDO, y los participantes son Carolina Espí Garcia, Jialing Zhang y José Pineda Torres. En el trabajo veremos un poco como influencia el petróleo en la economía.
